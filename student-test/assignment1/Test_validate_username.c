...
void test_validate_my_username()
{
     ...
     */
    const char* myUsername = {0};
    char* usernameFromConfFile = {0};

    myUsername = my_username();
    usernameFromConfFile = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(myUsername, usernameFromConfFile, "The two strings are equal");
}
